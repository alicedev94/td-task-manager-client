        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li v-if="hasPermission(1)">
                    <RouterLink to="/tables" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li v-if="hasPermission(2)">
                    <RouterLink to="/tablesExhibicion" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li v-if="hasPermission(1)">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <RouterLink to="/tables" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                Maestro de usuarios
                            </RouterLink>
                        </li>
                        <li>
                            <RouterLink to="/tablesRoles" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                Maestro de Roles
                            </RouterLink>
                        </li>
                    </ul>
                ...
                <li>
                    <div @click="handleLogout" class="flex items-center p-2 cursor-pointer text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                ...
                <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
                    La aplicacion se encuentra en modo desarrollo 💤
                </p>
                <a class="text-sm text-blue-800 underline font-medium hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" href="/dashboard">Ir al inicio</a>
            </div>
        </div>
    </aside>
</template>