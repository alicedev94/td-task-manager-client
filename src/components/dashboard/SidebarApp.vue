        ...
        <div class="flex flex-col justify-between h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li v-if="hasPermission(2)">
                    <RouterLink to="/tablesExhibition"
                        class="flex items-center p-2 text-gray-400 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li v-if="hasPermission(1)">
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-400 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <RouterLink to="/tables"
                                class="flex items-center w-full p-2 text-gray-400 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                Maestro de usuarios
                            </RouterLink>
                        </li>
                        <li>
                            <RouterLink to="/tablesRoles"
                                class="flex items-center w-full p-2 text-gray-400 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                Maestro de Roles
                            </RouterLink>
                        </li>
